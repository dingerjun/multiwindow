...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    /*Lenovo sw xiexl1 ltm-1 20120801 fixed the bug of panel background begin*/
    private boolean mbdefault_dark_background = true;
    private boolean mbDialog_activity = false;
    /*Lenovo sw xiexl1 ltm-1 20120801 fixed the bug of panel background end*/	
    ...
    private void openPanel(final PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == FEATURE_OPTIONS_PANEL) {
            ...
            //BEGIN Lenovo wangyq12 20131119 BLADEFHD-140 Add menu key support for apps.
            /*
        ...
        if(getContext().isIdeaUITheme() && (st.decorView != null && st.decorView.getChildCount() > 0)) {
    ...
    protected boolean initializePanelDecor(PanelFeatureState st) {
        ...
        /*Lenovo sw xiexl1 ltm-1 20120801 fixed the bug of panel background begin*/
        st.setStyle(getContext(), mbdefault_dark_background);
        /*Lenovo sw xiexl1 ltm-1 20120801 fixed the bug of panel background end*/		
    ...
    protected boolean onKeyDown(int featureId, int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_VOLUME_UP:
                ...
                intent1.setAction("com.lenovo.testcenter.VOLUME_UP_KEY_EVENT");
                intent1.putExtra("key_event", event);
    ...
    private final class DecorView extends FrameLayout implements RootViewSurfaceTaker {
        ...
        protected boolean fitSystemWindows(Rect insets) {
            /* begin, lenovo xucw 20130620 ltm-1 for support IdeaUI */
            if(mDecor == this) {
                // phone window'mDecor is this means this is not a openPanel window
                ideaUI_fitSystemWindows(insets);
            }
            /* end, lenovo xucw 20130620 ltm-1 for support IdeaUI */
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        if (mIsFloating) {
            ...
            /* begin, lenovo xucw 20130620 ltm-1 for support IdeaUI */  
            if(getContext().isIdeaUITheme() && false) {
                int bg = a.getResourceId(
                        com.android.internal.R.styleable.Window_windowBackground, 0);
                
                // do not show behind status bar if not Theme.Translucent theme
                if(bg != com.android.internal.R.color.transparent) {
                    setFlags(0, FLAG_LAYOUT_IN_SCREEN);
                }
            }
			/* end, lenovo xucw 20130620 ltm-1 for support IdeaUI */  
        }
        ...
        if (targetPreHoneycomb || ( noActionBar )) {
        //END BLADEFHD-140
            ...
            if (mBackgroundDrawable == null) {
                if (mBackgroundResource == 0) {
                    mBackgroundResource = a.getResourceId(
                            com.android.internal.R.styleable.Window_windowBackground, 0);
                    /*lenovo sw xiexl1 20130308 change activity background of dialog style begin*/
                    if( context instanceof Activity && !context.isCts() && Context.supportNonIdeaUITheme()) {
                        if( mBackgroundResource == com.android.internal.R.drawable.dialog_full_holo_light ) {
                            mBackgroundResource = com.lenovo.internal.R.drawable.dialog_full_holo_light;
                            mbDialog_activity = true;
                        } else if(mBackgroundResource == com.android.internal.R.drawable.dialog_full_holo_dark) {
                            mBackgroundResource = com.lenovo.internal.R.drawable.dialog_full_holo_dark;
                            mbDialog_activity = true;
                        }
                    }
                    /*lenovo sw xiexl1 20130308 change activity background of dialog style end*/
                }
                if (mFrameResource == 0) {
...
/*[lenovo_fw,zhaoll8,system_theme_main] ,"Refer to lenovo_fw.txt", add*/
                
                layoutResource = com.android.internal.R.layout.screen_action_bar;
                    
                /* begin, lenovo xucw 20130620 ltm-1 for support IdeaUI */
                if(getContext().isIdeaUITheme()) {
                   layoutResource = com.lenovo.internal.R.layout.screen_action_bar;
                }
                /* end, lenovo xucw 20130620 ltm-1 for support IdeaUI */
/*[lenovo_fw,zhaoll8,system_theme_main] ,end*/
            } else {
        ...
        if (getContainer() == null) {
            ...
            if (mBackgroundResource != 0) {
                /* begin, Lenovo sw xiexl1 ltm-1 20120502 change decorview's default's */
                if (!getContext().isCts() && Context.supportNonIdeaUITheme()) {
                    if (mBackgroundResource == com.android.internal.R.drawable.screen_background_selector_dark) {
                        mBackgroundResource = com.lenovo.internal.R.drawable.screen_background_selector_dark;
                    } else if (mBackgroundResource == com.android.internal.R.drawable.screen_background_selector_light) {
                        mBackgroundResource = com.lenovo.internal.R.drawable.screen_background_selector_light;
                    }
                }
                /* end, Lenovo sw xiexl1 ltm-1 20120502 change decorview's default's */
        ...
        /* begin, lenovo-sw xucw3 20120817 fix desk clock option menu BG issue */
        else {
            if(!getContext().isCts() && Context.supportNonIdeaUITheme()) {
                mbdefault_dark_background = containerIsDark();
            }
        }
        /* end, lenovo-sw xucw3 20120817 fix desk clock option menu BG issue */
    ...
    /*Lenovo sw xiexl1 ltm-1 add invertTextColor() begin*/
    private int invertBackground(int back_res) {
        return back_res;
    }
    
    /* begin, lenovo-sw xucw ltm-1  20120817 fix desk clock option menu BG issue */
    /**
     * @hide
     * return true if this window is dark background
     */
    public boolean isDark() {
        return mbdefault_dark_background;
    }
    
    /**
     * @hide
     * return true if container window is dark background
     */
    public boolean containerIsDark( ) {
        Window w = getContainer();
        if(w != null && w instanceof PhoneWindow ) {
            return ((PhoneWindow)w).isDark();
        }
        
        return true;
    }
    /* end, lenovo-sw xucw ltm-1  20120817 fix desk clock option menu BG issue */
    /*Lenovo sw xiexl1 ltm-1 add invertTextColor() end*/
    
    /* begin, lenovo xucw 20130620 ltm-1 for support IdeaUI */
    public void ideaUI_fitSystemWindows(Rect insets) {
        // change background according to system inset
        if(mDecor != null 
                && mDecor.getContext().isIdeaUITheme()) {
            if(mBackgroundResource == com.lenovo.internal.R.drawable.screen_background_selector_light) {
                // insets.top means status bar
                if(insets.top <= 0) {
                    setBackgroundDrawableResource(com.lenovo.internal.R.drawable.ideaui_full_screen_background_holo_light);
                }                
            } else if(mBackgroundResource == com.lenovo.internal.R.drawable.ideaui_full_screen_background_holo_light) {
                if(insets.top > 0) {
                    setBackgroundDrawableResource(com.lenovo.internal.R.drawable.ideaui_full_screen_background_holo_light);
                }  
            }
    ...
    private void installDecor() {
        ...
        if (mContentParent == null) {
            ...
            if (mTitleView != null) {
                ...
                /*lenovo sw xiexl1 20130308 change dialog activity's title color begin*/
                if (mbDialog_activity) {
                    if (mBackgroundResource == com.lenovo.internal.R.drawable.dialog_full_holo_light) {
                        mTitleView.setTextColor(0xff000000);
                    } else if (mBackgroundResource == com.lenovo.internal.R.drawable.dialog_full_holo_dark) {
                    ...
                    if (titleDivider != null) {
                        int color = getContext().getResources().getColor(
                                com.lenovo.internal.R.color.holo_blue_light);
                ...
                if (mActionBar != null) {
                    ...
                    if (splitView != null) {
                        ...
                        /* lenovo-sw chenjian2 add 20130711 for actionBar animation begin*/
                        Context context = getContext();
                    	/*if (IdeaUI.isPlatfromSupportIdeaUI() && !context.hasCts()) {
                    		Animation animation = AnimationUtils.loadAnimation(context, com.lenovo.internal.R.anim.actionbar_enter);
	                        splitView.startAnimation(animation);
                    		//LayoutAnimationController layoutAnimationController = new LayoutAnimationController(animation);
                    		//splitView.setLayoutAnimation(layoutAnimationController);
                    	}*/
                    	/* lenovo-sw chenjian2 add 20130711 for actionBar animation end*/
    ...
    private static final class PanelFeatureState {
        ...
        /*Lenovo sw xiexl1 ltm-1 20120801 fixed the bug of panel background begin*/
        void setStyle(Context context, boolean bdark) {
            TypedArray a = context.obtainStyledAttributes(com.android.internal.R.styleable.Theme);
            /*Lenovo sw xiexl1 ltm-1 20120305 change panel's background with theme's pannel background begin*/
            if(!context.isCts() && Context.supportNonIdeaUITheme()) {
                /* begin, lenovo-sw xucw 20120823 for baidu map option menu issue */
                int old_background_id = a.getResourceId(com.android.internal.R.styleable.Theme_panelBackground, 0);
                int old_fullBackground_id = a.getResourceId(com.android.internal.R.styleable.Theme_panelFullBackground, 0);
                
                if((old_background_id != com.android.internal.R.drawable.menu_hardkey_panel_holo_dark)
                        && (old_background_id != com.android.internal.R.drawable.menu_hardkey_panel_holo_light)) {
                    background = 0;
                    fullBackground = 0;
                }
                /* end, lenovo-sw xucw 20120823 for baidu map option menu issue */
            }
            if( background == 0 ) {
                background = a.getResourceId(com.android.internal.R.styleable.Theme_panelBackground, 0);
            }
            if( fullBackground == 0 ) {
                fullBackground = a.getResourceId(com.android.internal.R.styleable.Theme_panelFullBackground, 0);
            }
            /*Lenovo sw xiexl1 ltm-1 20120305 change panel's background with theme's pannel background end*/
