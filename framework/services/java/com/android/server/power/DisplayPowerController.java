...
final class DisplayPowerController {
    ...
    private static final int BRIGHTNESS_RAMP_RATE_SLOW = 200; //[BLADEFHD-2193][zhangsx10] change from 40 t0 200 to avoid backlight flashing
    ...
    private static final long DARKENING_LIGHT_DEBOUNCE = 6000; //[BLADEFHD-2208][zhangsx10] Change from 8000 to 6000
    /*< jiangsd@litsoft.com.cn Optimize AutoBrightness begin*/
    //When the light sensor vales lower than 19, I will adjust the backlight.
    private static final int MINIMUM_LSENSOR_VALUE = 19;
    private boolean mNowAdjustAutoBrightness = false;
    /* jiangsd@litsoft.com.cn Optimize AutoBrightness end >*/
    ...
    private void applyLightSensorMeasurement(long time, float lux) {
        ...
        if (mRecentLightSamples == 1) {
            ...
            /*< jiangsd@litsoft.com.cn Optimize AutoBrightness begin*/
            if (lux < MINIMUM_LSENSOR_VALUE) {
                mNowAdjustAutoBrightness = true;
                Slog.d(TAG, "Now Adjust AutoBrightness...");
            } else {
                mNowAdjustAutoBrightness = false;
            }
            /* jiangsd@litsoft.com.cn Optimize AutoBrightness end >*/
        }
    ...
    private void updateAmbientLux(long time) {
        ...
        if (!mAmbientLuxValid) {
            ...
            setAmbientLux(Math.max(mRecentShortTermAverageLux, mRecentLongTermAverageLux));
                /*< jiangsd@litsoft.com.cn Optimize AutoBrightness begin*/
                if (mNowAdjustAutoBrightness) {
                    mAmbientLux = 0;
                    mNowAdjustAutoBrightness = false;
                    Slog.d(TAG, "Now Adjust AutoBrightness Lux Value is 0.");
                }
                /* jiangsd@litsoft.com.cn Optimize AutoBrightness end >*/
            if (DEBUG) {
