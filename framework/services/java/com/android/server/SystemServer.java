...
import com.lenovo.systemtheme.SystemThemeService;
/* end, Lenovo sw xucw ltm-1 20130321 for support system theme*/
/* begin, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
 import com.lenovo.launchericontheme.LaunchIconThemeResource;
 import com.lenovo.launchericontheme.LaunchIconThemeService;
/* end, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        /* begin [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
        HallObserver hall = null;
        CapsensorObserver capsensor = null;
        MrsensorObserver mrsensor = null;
        /* end [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
        UsbService usb = null;
        ...
        /* begin, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
        LaunchIconThemeService mLaunchIconThemeService = null;
        /* end, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
        ...
        if(LenovoFeatureOption.LENOVO_POWEROFF_CLOCK_SUPPORT){
            if(StartShutdownService.getStaticBootMode() == StartShutdownManager.BOOTMODE_CHARGEIN){
                Looper.loop();
            }
        }
//dingej1 2014.04.16 begin. BLADEFHD-3548. Workaround to delay system init to let bootanimation play completely.
        try {
            Thread.sleep(3*1000);
        } catch (Exception e) {
        }
//dingej1 end.
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (SystemThemeResource.SUPPORT_SYSTEM_THEME) {
                try {
                    Slog.i(TAG, "System Theme");

                    SystemThemeService systemThemeService;
                    systemThemeService = new SystemThemeService(context);
                    
                    systemThemeService.systemReady();

                    ServiceManager.addService(Context.SYSTEM_THEME_SERVICE, systemThemeService);
                } catch (Throwable e) {
                    Slog.e(TAG, "Failure starting SystemThemeService", e);
                }
            }
            /* end, Lenovo sw xucw ltm-1 20130321 for support system theme*/
            ...
            /* begin [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
            try {
                Slog.i(TAG, "Hall sensor Observer");
                // Listen for hall changes
                hall = new HallObserver(context);
            } catch (Throwable e) {
                reportWtf("starting HallObserver", e);
            }

            try {
                Slog.i(TAG, "Capsensor Observer");
                // Listen for capsensor changes
                capsensor = new CapsensorObserver(context);
            } catch (Throwable e) {
                reportWtf("starting CapsensorObserver", e);
            }

            try {
                Slog.i(TAG, "Mrsensor Observer");
                // Listen for mrsensor changes
                mrsensor = new MrsensorObserver(context);
            } catch (Throwable e) {
                reportWtf("starting Mrsensor", e);
            }
            /* end [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
            ...
            /* begin, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
            if(LenovoFeatureOption.LENOVO_LAUNCHICON_THEME_SUPPORT) {
                try {
                    Slog.i(TAG, "LaunchIconThemeService");
                    mLaunchIconThemeService = new LaunchIconThemeService(context);
                    ServiceManager.addService(LaunchIconThemeService.SERVICE_NAME, mLaunchIconThemeService);
                } catch (Throwable e) {
                    Slog.e(TAG, "FAIL starting LaunchIconThemeService", e);
                }
            }
            /* end, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
        ...
        StartShutdownService ss = null;
        if(LenovoFeatureOption.LENOVO_POWEROFF_CLOCK_SUPPORT){
            Log.i(TAG, "Starting StartShutdown Service.");
            ss = StartShutdownService.main(context, factoryTest);
            ServiceManager.addService(Context.START_SHUTDOWN_SERVICE, ss);
        }
        ...
        /* begin [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
        final HallObserver hallF = hall;
        final CapsensorObserver capsensorF = capsensor;
        final MrsensorObserver mrsensorF = mrsensor;
        /* end [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
        ...
        /* begin, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
        final LaunchIconThemeService launchIconThemeServiceF = mLaunchIconThemeService;
        /* end, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
                ...
                /* begin [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
                try {
                    if (hallF != null) hallF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making Hall sensor Service ready", e);
                }
                try {
                    if (capsensorF != null) capsensorF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making Capsensor Service ready", e);
                }
                try {
                    if (mrsensorF != null) mrsensorF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making Mrsensor Service ready", e);
                }
                /* end [BLADEFHD-18][zhangsx10] Support hall/cap/mr sensors in frameworks */
                try {
                ...
                {
                    try {
                        if(launchIconThemeServiceF != null){
                            Slog.i(TAG, "LaunchIconThemeService systemReady");
                            launchIconThemeServiceF.systemReady();
                        }
                    } catch (Throwable e) {
                        Slog.e(TAG, "LaunchIconThemeService systemReady failed", e);
                    }
                }
                /* end, lenovo.sw zengzm added 2013.07.10 for launch icon theme*/
            }
