...
//dingej1 end.
    ...
    private void insertTaskAtTop(TaskRecord task) {
        insertTaskAtTop(task, false);
    }

    private void insertTaskAtTop(TaskRecord task, boolean showOnLockScreen) {
    ...
    final void startActivityLocked(ActivityRecord r, boolean newTask,
        ...
        if (taskForIdLocked(taskId) == null || newTask) {
            ...
            boolean showOnLockScreen = (r.info.flags & ActivityInfo.FLAG_SHOW_ON_LOCK_SCREEN) != 0;
            insertTaskAtTop(rTask, showOnLockScreen);
