...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d("NetworkController","action is " + action);
    ...
    PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState state) {
            ...
            updateDataNetType();
            updateDataIcon();
            //when service state changeds,update network name again
    ...
    private void refreshLocale() {
        ...
        // change by xutg1, BLADEFHDKK-827, No service displays in old locale
        String oldNetworkNameDefault = mNetworkNameDefault;
        mNetworkNameDefault = mContext.getString(com.android.internal.R.string.lockscreen_carrier_default);
        if(oldNetworkNameDefault.equals(mNetworkName)){
            mNetworkName = mNetworkNameDefault;
        }
        // change end, BLADEFHDKK-827
    }
    ...
    void updateNetworkName(boolean showSpn, String spn, boolean showPlmn, String plmn) {
        if (true) {
            Log.d("CarrierLabel + network", "updateNetworkName showSpn=" + showSpn + " spn=" + spn
        ...
        /** show spn when service state is in sevice and doesn't show spn in other service state*/
        if (!something) {
        ...
        Log.d("networkcontroller","mNetworkName is " + mNetworkName);
        Log.d("networkcontroller"," mNetworkNameDefault is "  + mNetworkNameDefault);
    }
    int getCombinedRegState() {
        int regState = mServiceState.getVoiceRegState();
        int dataRegState = mServiceState.getDataRegState();
        Log.d("networkcontroller","wangyq regState = " + regState +", dataRegState = " + dataRegState);
        if ((regState == ServiceState.STATE_OUT_OF_SERVICE)
                && (dataRegState == ServiceState.STATE_IN_SERVICE)) {
            Log.d("networkcontroller","getCombinedRegState: return STATE_IN_SERVICE as Data is in service");
            regState = dataRegState;
        }
        //Log.d("networkcontroller","wangyq regState= " + regState);
        return regState;
    }
    // ===== Wifi ===================================================================
    ...
    void refreshViews() {
        ...
        if (!mHasMobileDataFeature || (mSimState == IccCardConstants.State.ABSENT)) {
        ...
        if (mLastPhoneSignalIconId          != mPhoneSignalIconId
         ...
         || mLastLocale                     != mLocale
         || (mLastNetworkName != null & !mLastNetworkName.equals(mNetworkName))
    ...
    private int mDemoDataActivityId;
    ...
    public void dispatchDemoCommand(String command, Bundle args) {
        if (!mDemoMode && command.equals(COMMAND_ENTER)) {
            ...
            mDemoDataActivityId = mMobileActivityIconId;
            ...
            if (wifi != null) {
                ...
                if (level != null) {
                    ...
                    switch (mWifiActivity) {
                        case WifiManager.DATA_ACTIVITY_IN:
                            mDemoWifiActivityId = R.drawable.stat_sys_wifi_in;
                            break;
                        case WifiManager.DATA_ACTIVITY_OUT:
                            mDemoWifiActivityId = R.drawable.stat_sys_wifi_out;
                            break;
                        case WifiManager.DATA_ACTIVITY_INOUT:
                            mDemoWifiActivityId = R.drawable.stat_sys_wifi_inout;
                            break;
                        case WifiManager.DATA_ACTIVITY_NONE:
                            mDemoWifiActivityId = 0;
                            break;
                    }
                }
            ...
            if (mobile != null) {
                ...
                if (datatype != null) {
                    ...
                    switch (mDataActivity) {
                        case TelephonyManager.DATA_ACTIVITY_IN:
                            mDemoDataActivityId = R.drawable.stat_sys_signal_in;
                            break;
                        case TelephonyManager.DATA_ACTIVITY_OUT:
                            mDemoDataActivityId = R.drawable.stat_sys_signal_out;
                            break;
                        case TelephonyManager.DATA_ACTIVITY_INOUT:
                            mDemoDataActivityId = R.drawable.stat_sys_signal_inout;
                            break;
                        default:
                            mDemoDataActivityId = 0;
                            break;
                    }
                }
