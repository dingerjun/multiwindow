...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    public QuickSettingsModel(Context context) {
        ...
        IntentFilter configurationIntentFilter = new IntentFilter();
        configurationIntentFilter.addAction(Intent.ACTION_CONFIGURATION_CHANGED);
        context.registerReceiver(mConfigurationReceiver, configurationIntentFilter);
    }
    ...
    protected void onConfigurationChanged() {
        if (this.mBatteryTile != null) {
            this.mBatteryCallback.refreshView(mBatteryTile, mBatteryState);
        }
    }
