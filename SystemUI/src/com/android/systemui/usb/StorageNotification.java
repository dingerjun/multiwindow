...
public class StorageNotification extends SystemUI {
    ...
    // add by xutg1, add OTG storage support
    private static final String OTG_MOUNT_POINT = "/storage/usbotg";
    // add end
    ...
    private void onStorageStateChangedAsync(String path, String oldState, String newState) {
        ...
        if (newState.equals(Environment.MEDIA_SHARED)) {
            ...
            // changed by xutg1, add OTG storage support
            int title = com.android.internal.R.string.ext_media_checking_notification_title;
            int message = com.android.internal.R.string.ext_media_checking_notification_message;
            if(path.equals(OTG_MOUNT_POINT)) {
                title = com.android.internal.R.string.ext_media_otg_checking_notification_title;
                message = com.android.internal.R.string.ext_media_otg_checking_notification_message;
            }
            ...
            if (!mStorageManager.isUsbMassStorageEnabled()) {
                if (oldState.equals(Environment.MEDIA_SHARED)) {
                    ...
                    // add by xutg1, add OTG storage support
                    int title = com.android.internal.R.string.ext_media_safe_unmount_notification_title;
                    int message = com.android.internal.R.string.ext_media_safe_unmount_notification_message;
                    if(path.equals(OTG_MOUNT_POINT)) {
                        title = com.android.internal.R.string.ext_media_otg_safe_unmount_notification_title;
                        message = com.android.internal.R.string.ext_media_otg_safe_unmount_notification_message;
                    }
            ...
            // add by xutg1, add OTG storage support
            int title = com.android.internal.R.string.ext_media_nofs_notification_title;
            int message = com.android.internal.R.string.ext_media_nofs_notification_message;
            if(path.equals(OTG_MOUNT_POINT)) {
                title = com.android.internal.R.string.ext_media_otg_nofs_notification_title;
                message = com.android.internal.R.string.ext_media_otg_nofs_notification_message;
            }
            setMediaStorageNotification(
                    title,
                    message,
            ...
            // add by xutg1, add OTG storage support
            int title = com.android.internal.R.string.ext_media_unmountable_notification_title;
            int message = com.android.internal.R.string.ext_media_unmountable_notification_message;
            if(path.equals(OTG_MOUNT_POINT)) {
                title = com.android.internal.R.string.ext_media_otg_unmountable_notification_title;
                message = com.android.internal.R.string.ext_media_otg_unmountable_notification_message;
            }
            setMediaStorageNotification(
                    title,
                    message,
            ...
            // add by xutg1, add OTG storage support
            int title = com.android.internal.R.string.ext_media_nomedia_notification_title;
            int message = com.android.internal.R.string.ext_media_nomedia_notification_message;
            if(path.equals(OTG_MOUNT_POINT)) {
                title = com.android.internal.R.string.ext_media_otg_nomedia_notification_title;
                message = com.android.internal.R.string.ext_media_otg_nomedia_notification_message;
            }
            setMediaStorageNotification(
                    title,
                    message,
            ...
            // add by xutg1, add OTG storage support
            int title = com.android.internal.R.string.ext_media_badremoval_notification_title;
            int message = com.android.internal.R.string.ext_media_badremoval_notification_message;
            if(path.equals(OTG_MOUNT_POINT)) {
                title = com.android.internal.R.string.ext_media_otg_badremoval_notification_title;
                message = com.android.internal.R.string.ext_media_otg_badremoval_notification_message;
            }
            setMediaStorageNotification(
                    title,
                    message,
